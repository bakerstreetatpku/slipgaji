...
<body class="hold-transition skin-blue sidebar-mini">
          ...
          <!-- hide menu -->
			<li class="treeview" nm="Data Master">
              ...
              <ul class="treeview-menu">
					...
					<li><a href="absen"><i class="fa fa-angle-double-right"></i> <span>Absen</span></a></li>
					<li><a href="gaji"><i class="fa fa-angle-double-right"></i> <span>Gaji</span></a></li>
					<li><a href="cetakgaji"><i class="fa fa-angle-double-right"></i> <span>Cetak Gaji</span></a></li>
              </ul>
            </li>
	...
	<input type="hidden" id="hdr" value="<?= URL::to('/');?>">
		<div class="inner">
		<div class="row">
		<div class="col-lg-12">
				<br />
				<div class = "col-md-2 col-xs-12">
					<div class = "form-group">
						<a href="#" class="btn btn-primary btn-block" id="gj_tambah"><i class="fa fa-plus"></i> &nbsp;&nbsp;&nbsp; Tambah Data</a>
					</div>
				</div>
				<div class = "col-md-2 col-xs-12">
					<div class = "form-group">
				...
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="tabel-gaji" width="100%" style="font-size:120%;">
								<thead>
									<tr>
										<th>No</th>
										<th>Pegawai</th>
								...
								<tbody>
									...
									foreach($table as $p)
									{ 
										$pg = DB::table('bnd_pegawai')->where('peg_id',$p->gj_peg_id)->first();
										?>
									<tr>
										<td><?=$no;?></td>
										<td><?=$pg->peg_nama;?></td>
										<td align="right"><?=number_format($p->gj_pokok,0,",",".");?></td>
										<td align="right"><?=number_format($p->gj_makan,0,",",".");?></td>
										<td align="right"><?=number_format($p->gj_transport,0,",",".");?></td>
										<td align="right"><?=number_format($p->gj_lembur,0,",",".");?></td>
										<td><a href="#" onClick="ubah_gaji(<?= $p->gj_id?>)" class="btn btn-info" title="Ubah data Gaji"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onClick="hapus_gaji(<?= $p->gj_id;?>)" class="btn btn-danger" title="Hapus data Gaji"><i class="fa fa-remove"></i></a></td>
									</tr>
									<?php 
									$no++; }?>
								</tbody>
		...
		<!-- Bootstrap modal -->
			<div class="modal fade" id="modal_gaji" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h3 class="modal-title"><i class="glyphicon glyphicon-info"></i> Form Gaji</h3>
						</div>
						<form role="form col-lg-6" name="Gaji" id="frm_gaji">
						<input type="hidden" id="_token" name="_token" value="<?= csrf_token();?>">
						<div class="modal-body form">
							<div class="row">
								<input type="hidden" id="gj_id" name="gj_id" value="">
								<div class="col-lg-6">
									<div class="form-group">
										<label>Pegawai</label>
										<select name="gj_peg_id" id="gj_peg_id" class="form-control">
										<?php 
											foreach($pegawai as $lp)
											{
												?>
												<option value="<?=$lp->peg_id;?>"><?=$lp->peg_nama;?></option>
											<?php } ?>
										</select>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										<label>Pokok</label>
										<input type="text" class="form-control" name="gj_pokok" id="gj_pokok" placeholder="Pokok" value="">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										<label>Makan</label>
										<input type="text" class="form-control" name="gj_makan" id="gj_makan" placeholder="Makan" value="">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										<label>Transport</label>
										<input type="text" class="form-control" name="gj_transport" id="gj_transport" placeholder="Transport" value="">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										<label>Lembur (per jam)</label>
										<input type="text" class="form-control" name="gj_lembur" id="gj_lembur" placeholder="Lembur per jam" value="">
									</div>
								</div>
							</div>
						</div>
						<div class="modal-footer">
							<button type="submit" id="gj_simpan" class="btn btn-primary">Simpan</a>
			...
			<!-- Custom Java Script -->
			<script src="assets/js/gaji.js"></script>
		 </div><!-- /.content-wrapper -->
      <footer class="main-footer">
        <div class="pull-right hidden-xs">
          <b>Version</b> 1.0
        </div>
        <strong>Copyright &copy; 2019 bandingin.com</strong> All rights reserved.
      </footer> 
