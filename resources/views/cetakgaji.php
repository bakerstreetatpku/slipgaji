...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <section class="content-header">
		  ...
		  <ol class="breadcrumb">
            <li style="width:100%;"><a href="#">
				<marquee style="background:white;border-radius:5px; color:black; "scrolldelay="1" scrollamount="3" direction="left">Sistem Pengcetakgajian <b>bandingin.com</b> [copyright &copy; 2019] </marquee>
			</a></li>
          </ol>
		  </div>
        </section>
	...
	<input type="hidden" id="hdr" value="<?= URL::to('/');?>">
		...
		<div class="col-lg-12">
				...
				<div class = "col-md-2 col-xs-12">
					<div class = "form-group">
						<select name="periodeabsen" id="periodeabsen" class="form-control">
						<?php
							foreach($periodeabsen as $pa)
							{
								?>
								<option value="<?=$pa->pra_id;?>"><?=$pa->pra_thn ." - ". $bln[$pa->pra_bln];?></option>
							<?php }
							?>
						</select>
					</div>
				...
				<div class = "col-md-2 col-xs-12">
					<div class = "form-group">
						<a href="#" id="tampilGaji" class="btn btn-success btn-block"><i class="fa fa-check"></i> &nbsp;&nbsp;&nbsp; Tampil</a>
					</div>
				</div>
				<div class = "col-md-2 col-xs-12">
					<div class = "form-group">
						<a href="#" id="printGaji" class="btn btn-info btn-block"><i class="fa fa-print"></i> &nbsp;&nbsp;&nbsp; Cetak</a>
					</div>
				</div>
				<br />
				<br />
		...
		<div class="row" id="isidata">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						...
						<div class="table-responsive" id="isiCetakGaji">
			...
			<!-- Custom Java Script -->
			<script src="assets/js/cetakgaji.js"></script>
		 </div><!-- /.content-wrapper -->
