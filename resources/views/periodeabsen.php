...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<input type="hidden" id="hdr" value="<?= URL::to('/');?>">
		...
		<div class="col-lg-12">
				...
				<div class = "col-md-2 col-xs-12">
					<div class = "form-group">
						<a href="#" class="btn btn-primary btn-block" id="pra_tambah"><i class="fa fa-plus"></i> &nbsp;&nbsp;&nbsp; Tambah Data</a>
					</div>
				</div>
				<div class = "col-md-2 col-xs-12">
					<div class = "form-group">
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						Data Kriteria PeriodeAbsen
					</div>
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="tabel-periodeabsen" width="100%" style="font-size:120%;">
								<thead>
									<tr>
										<th>No</th>
										<th>Bulan</th>
								...
								<tbody>
									...
									<tr>
										...
										<td><?=$p->pra_thn;?></td>
										<td><?=$p->pra_jml_hr;?></td>
										<td><a href="#" onClick="ubah_periodeabsen(<?= $p->pra_id?>)" class="btn btn-info" title="Ubah data PeriodeAbsen"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onClick="hapus_periodeabsen(<?= $p->pra_id;?>)" class="btn btn-danger" title="Hapus data PeriodeAbsen"><i class="fa fa-remove"></i></a></td>
									</tr>
									<?php 
									$no++; }?>
								</tbody>
		...
		<!-- Bootstrap modal -->
			<div class="modal fade" id="modal_periodeabsen" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						<div class="modal-header">
							<h3 class="modal-title"><i class="glyphicon glyphicon-info"></i> Form PeriodeAbsen</h3>
						</div>
						<form role="form col-lg-6" name="PeriodeAbsen" id="frm_periodeabsen">
						<input type="hidden" id="_token" name="_token" value="<?= csrf_token();?>">
						<div class="modal-body form">
							<div class="row">
								<input type="hidden" id="pra_id" name="pra_id" value="">
								<div class="col-lg-6">
									<div class="form-group">
										<label>Periode</label>
								...
								<div class="col-lg-6">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="pra_jml_hr" id="pra_jml_hr" placeholder="Jumlah Hari" value="">
									</div>
								</div>
							</div>
						</div>
						<div class="modal-footer">
							<button type="submit" id="pra_simpan" class="btn btn-primary">Simpan</a>
			...
			<!-- Custom Java Script -->
			<script src="assets/js/periodeabsen.js"></script>
		 </div><!-- /.content-wrapper -->
