		...
		<div class="col-lg-12">
				...
				<div class = "col-md-2 col-xs-12">
					<div class = "form-group">
						<a href="#" class="btn btn-primary btn-block" id="peg_tambah"><i class="fa fa-plus"></i> &nbsp;&nbsp;&nbsp; Tambah Data</a>
					</div>
				</div>
				<div class = "col-md-2 col-xs-12">
					<div class = "form-group">
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="tabel-pegawai" width="100%" style="font-size:120%;">
								...
								<tbody>
									...
									<tr>
										<td><?=$no;?></td>
										<td><img src="assets/dist/img/user-blank.png" width="50" height="50"></td>
										<td><?=$p->peg_nama;?></td>
										<td><?=$p->peg_nip;?></td>
										<td><?=$p->peg_tempat_lahir;?>, <?=date("d F Y",strtotime($p->peg_tanggal_lahir));?></td>
										<td><?=$p->peg_jk;?></td>
										<td><a href="#" onClick="ubah_pegawai(<?= $p->peg_id?>)" class="btn btn-info" title="Ubah data Pegawai"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="#" onClick="hapus_pegawai(<?= $p->peg_id;?>)" class="btn btn-danger" title="Hapus data Pegawai"><i class="fa fa-remove"></i></a></td>
									</tr>
									<?php 
									$no++; }?>
								</tbody>
			...
			<div class="modal fade" id="modal_pegawai" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form role="form col-lg-6" name="Pegawai" id="frm_pegawai">
						...
						<div class="modal-body form">
							<div class="row">
								...
								<div class="col-lg-6">
									<div class="form-group">
										<label>NIP</label>
										<input type="text" class="form-control" name="peg_nip" id="peg_nip" placeholder="NIP" value="">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										<label>Nama</label>
										<input type="text" class="form-control" name="peg_nama" id="peg_nama" placeholder="Nama" value="">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										<label>Tempat Lahir</label>
										<input type="text" class="form-control" name="peg_tempat_lahir" id="peg_tempat_lahir" placeholder="Tempat Lahir" value="">
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										<label>Tanggal Lahir</label>
										<input type="text" class="form-control tgl" name="peg_tanggal_lahir" id="peg_tanggal_lahir" placeholder="Tanggal Lahir" value="<?=date("d/m/Y", strtotime("2003-01-01"));?>"0>
									</div>
								</div>
								<div class="col-lg-6">
									<div class="form-group">
										<label>Jenis Kelamin</label>
										<select class="form-control" name="peg_jk" id="peg_jk">
								...
								<div class="col-lg-6">
									<div class="form-group">
										<label>Agama</label>
										<select class="form-control" name="peg_agama" id="peg_agama">
						...
						<div class="modal-footer">
							<button type="submit" id="peg_simpan" class="btn btn-primary">Simpan</a>
