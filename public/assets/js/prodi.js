...
$("#prd_simpan").click(function(){
	var dataString = $("#frm_prodi").serialize();
	$("#prd_simpan").html("Menyimpan...");
...
function ubah_prodi(id)
{
	$.ajax({
		...
		success	: function(data){
			...
			$("#prd_kode").val(data.prd_kode);
			$("#prd_kepala").val(data.prd_kepala);
